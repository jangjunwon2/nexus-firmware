...
constexpr uint8_t BOOST_EN_PIN      = 8;  // [NEW] 24V 승압 회로 EN 핀 추가
...
constexpr const char* AP_SSID = "Nexus_FluxCase";
...
enum class LedPatternType {
    ...
    LED_PAIRING, // [NEW] 페어링용 LED 점멸 패턴 추가
    LED_ERROR
};
